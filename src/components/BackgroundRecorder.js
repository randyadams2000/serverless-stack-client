...
export class BackgroundRecorder extends React.Component {
 ...
 //       super(props);
    ...
    async componentDidMount() {
        ...
        var theStream = theCanvas.captureStream(25);
        theVideo.srcObject = theStream;
        theVideo.play();
